...
export const loginSendOtp = async (mobile_number) => {
  try {
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/login/send-otp",
      {
        mobile_number,
      },
      config_urlencoded
...
export const loginVerifyOtp = async (mobile_number, otp) => {
  try {
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/login/verify-otp",
      {
        mobile_number,
        otp,
      },
...
export const signupSendOtp = async (
  ...
  try {
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/signup/send-otp",
      {
        mobile_number,
        name,
        email,
...
export const signupVerifyOtp = async (mobile_number, otp) => {
  try {
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/signup/verify-otp",
      {
        mobile_number,
        otp,
      },
...
export const refreshBearerToken = async (token) => {
  ...
  try {
    const res = await axios.get(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/refresh-tokens",
      configs
    );
...
export const getProductsList = async (
  ...
  try {
    ...
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/reown/models",
      post_data,
      config_urlencoded
    );
    return createResponse(200, "success", res.data);
...
export const getFilters = async () => {
  try {
    const res = await axios.get(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/reown/get-filters"
    );
    return createResponse(200, "success", res.data);
  } catch (err) {
    return createExceptionResponse(err);
  ...
  try {
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL +
        "/reown/check-pincode-servicability",
      {
        to_pincode,
      },
      config_urlencoded
...
export const addToCart = async (
  ...
  try {
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/reown/cart/add",
      {
        product_sku_id,
        quantity,
        custom_ram,
...
export const clearCart = async (token, product_sku_id = null) => {
  ...
  try {
    ...
    const res = await axios.get(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + url,
      configs
    );
    return createResponse(200, res.data.message ?? "", res.data ?? []);
  } catch (err) {
...
export const getCart = async (token) => {
  ...
  try {
    const res = await axios.get(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/reown/cart",
      configs
    );
    return createResponse(200, res.data.message ?? "", res.data ?? []);
  } catch (err) {
...
export const getProfileDetails = async (token) => {
  ...
  try {
    const res = await axios.get(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL +
        "/manage-profile/get-profile-full-details",
      configs
    );
    return createResponse(200, res.data.message ?? "", res.data ?? []);
  } catch (err) {
...
export const updateDeliveryAddressDetails = async (
  token,
  name,
  email,
  shipto_houseno,
...
export const checkEstimatedDelivery = async (token, to_pincode) => {
  try {
    ...
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL +
        "/reown/check-estimated-delivery",
      { to_pincode },
      configs
    );
    return createResponse(200, res.data.message ?? "", res.data ?? []);
...
export const applyCoupon = async (token, coupon_code) => {
  try {
    let configs = getHeadersWithAuth(token);
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/reown/validate-coupon",
      { coupon_code },
      configs
    );
    return createResponse(200, res.data.message ?? "", res.data ?? []);
...
export const revokeCoupon = async (token) => {
  try {
    let configs = getHeadersWithAuth(token);
    const res = await axios.get(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/reown/revoke-coupon",
      configs
    );
    return createResponse(200, res.data.message ?? "", res.data ?? []);
  } catch (err) {
...
export const purchaseOrdersList = async (token, limit = "", offset = "") => {
  try {
    let configs = getHeadersWithAuth(token);
    const res = await axios.post(
      process.env.NEXT_PUBLIC_RAPIV2_BASE_URL + "/reown/orders-list",
      { limit, offset },
      configs
    );
    return createResponse(200, res.data.message ?? "", res.data ?? []);
