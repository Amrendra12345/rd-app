import { createSlug } from "@/servers/lib-reown/lib";
...
const RelatedProducts = ({ relatedProduct }) => {
  return (
    <div className="container mt-4">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 mt-8 mb-10">
