...
const CartAddress = (props) => {
  ...
  const handleAddressSubmit = () => {
    ...
    dispatch(
      profileActions.saveDeliveryDetails({
        ...
        billing_houseno: billingSame
          ? deliveryHouseRef.current.value
          : billingHouseRef.current.value,
        billing_street: billingSame
          ? deliveryStreetRef.current.value
          : billingStreetRef.current.value,
        billing_locality: billingSame
          ? deliveryLocalityRef.current.value
          : billingLocalityRef.current.value,
        billing_city: billingSame
          ? deliveryCityRef.current.value
          : billingCityRef.current.value,
        billing_state: billingSame
          ? deliveryStateRef.current.value
          : billingStateRef.current.value,
        billing_pincode: billingSame
          ? deliveryPincodeRef.current.value
          : billingPincodeRef.current.value,
  ...
  return (
    <div className="page_card">
      <div className="cart__delivery__address_content">
        {deliveryAddress ? (
          <>
            <div className="deliveyAddress">
              <div className="page_title">
                <p>
                  <Image
                    src="/images/address__icon.svg"
                    width={22}
                    height={20}
                    alt="address icon"
                  />
              ...
              <div className="edit_address">
                <button
                  type="button"
                  className={`btn btn-edit ${isActive ? "active" : ""}`}
                  onClick={toggleHandler}
                >
                  Edit <BsFillArrowRightCircleFill />
                </button>
              </div>
            </div>
            <div className="delivery_img">
              <Image
                src="/images/address__banner.svg"
                alt="address banner"
                width="160"
                height={80}
              />
      ...
      <div
        className={`shipping__Address ${
          isActive || !deliveryAddress ? "active" : ""
        }`}
      >
        <hr />
