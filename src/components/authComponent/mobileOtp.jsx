    ...
    >
      ...
      >
        ...
        <div className="p-6 border border-r-0 border-l-0">
          ...
          <p className="text-gray-500 block mb-6 text-[15px]">
            We’ve sent an OTP on{" "}
            <span className="text-gray-900 tracking-wider font-semibold">
              {auth.userMobile}
            </span>{" "}
          </p>
          ...
          <p className="text-[14px] text-teal-700 font-semibold mt-1">
            Resend OTP
          </p>
          <div className="">
            <button
