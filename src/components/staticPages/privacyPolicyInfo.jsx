      ...
      <section className="terms">
        <div className="container mt-5">
          <div className="flex justify-center my-8">
            <h2 className="font-bold text-3xl text-gray-800">Privacy Policy</h2>
          </div>
          <div className="cards">
            <div className="card">
              <p>
                Recycledevice value the trust you place in us and knows that you
                care how information about you is used and shared and we
                appreciate your trust in us to do that carefully and sensibly.
              </p>
              <p>
                This privacy policy ( the<strong> “privacy policy”</strong> ),
                together with the terms of use, describes Recycledevice’s
                policies and procedures on the collection, use and disclosure of
                the information provided by users and visitors ( as defined
                herein below ) of the websites and the mobile applications.
              </p>{" "}
              <br />
              <p>
                <strong className="title"> Note:</strong> Our privacy policy is
                subject to change at any time without notice. To make sure you
                are aware of any changes, please review this policy
                periodically.
              </p>
              <p>
                By visiting this website or mobile application you agree to be
                bound by the terms and conditions of this privacy policy. If you
                do not agree please do not use or access our platform.
              </p>
              <p>
                By mere use of the website and mobile app, you expressly consent
              ...
              <p>
                This privacy policy sets out the type of information collected
                from the users, including the nature of the sensitive personal
                data or information, the purpose, means and modes of usage of
                such information and how and to whom Recycledevice shall
              ...
              <ol style={{ listStyleType: "disc", marginBottom: "0.5rem" }}>
                <li>
                  Your privacy is important to Recycledevice, and we are trying
                  to ensure that no such information collected from you other
                  than what is necessary to provide services/goods of
                  Recycledevice and to protect your account on Recycledevice’s
                  platform.
                </li>
                <li>
                  Information that is required to place an order on
                  Recycledevice platform is name, address, phone number, email
                  address, financial details for selected payment method,
                  Identity and Address proof etc. The above-mentioned
                  information will be collected at the time of placement of your
                  order.
                </li>
                <li>
                  The financial information collected from the user is
                  transacted through secure digital platforms of approved
                  payment gateways which are under encryption, thereby complying
                  with reasonably expected technology standards. While
                  Recycledevice shall make reasonable endeavors to ensure that
                  the {`user’s`} personal information and the financial
                  information is duly protected by undertaking security measures
                  prescribed under applicable laws, the user is strongly advised
                  to exercise discretion while providing personal information or
                  financial information while using the services given that the
                  internet is susceptible to security breaches.
                </li>
                <li>
                  If user choose to post messages on our message boards, chat
                  rooms or other message areas or leave feedback, we will
                  collect that information user provide to us. We retain this
                  information as necessary to resolve disputes, provide customer
                  support and troubleshoot problems as permitted by law.
                </li>
                <li>
                  If user send us personal correspondence, such as emails or
                  letters, or if other users or third parties send us
                  correspondence about {`user’s`} activities or postings on the
                  website, we may collect such information into a file specific
                  to user.
                </li>
                <li>
                  It is mandatory for users of the platform to provide certain
                  categories of user data (as specified at the time of
                  collection). In the event that users do not provide any or
                  sufficient user data marked as mandatory, Recycledevice may
                  not be able process the order or provide such users with
                  Recycledevice’s services.
                </li>
                <li>
                  All the above-mentioned information is collectively referred
                  to as user data.
                </li>
                <li>
                  Sometime the platform uses cookies so that the platform can
                  provide the user with more customized information when the
                  ...
                  the user agrees to the use of any user information collected
                  by the platform using that cookie. The user may update the
                  profile information of the user at any time on the platform.
                </li>
                <li>
                  The use can add or update the user information on a regular
                  basis. When the user updates the user information,
                  Recycledevice will keep a copy of the prior version for its
                  record.
                </li>
              </ol>
              ...
              <ol style={{ listStyleType: "disc", marginBottom: "0.5rem" }}>
                <li>
                  That the{" "}
                  {`user's information is primarily used by Recycledevice to facilitate a better, customized, and convenient use of the platform's services. The user's `}
                  information is used by Recycledevice inter alia
                </li>
                ...
                <li>
                  Examine the identity of the {`users'`} and the authenticity of
                  offers, delivery or transfer of offers, etc.;
                </li>
                <li>Administer the platform;</li>
                <li>
                  Inform any change in the terms of use or this policy or the
                  terms and conditions.
                </li>
                <li>
                  Send surveys and marketing communications that Recycledevice
                  believes may be of interest to the user.
                </li>
                <li>
                  Personalize the {`users'`} experience on the platform by
                  presenting advertising, products and offers tailored for the
                  user;
                </li>
                <li>
                  Help the user address its problems with the platform including
                  addressing any technical problems;
                </li>
                <li>
                  Complete and fulfill the {`users'`}order, communicate with the
                  user regarding the {`users'`} order and provide the user with
                  related customer service.
                </li>
                <li>
                  If user voluntarily submit any user information or other
                  information to the platform for publication on the platform
                  through the publishing tools, then users are deemed to have
                  given consent to the publication of such information on the
                  platform; and
                </li>
                <li>Protect the integrity of the platform.</li>
                <li>
                  With your consent, we will have access to your SMS, contacts
                  in your directory, location, and device information. We may
                  share this data with our affiliates. In the event that consent
                  to this such use of data is withdrawn in the future, we will
                  stop collection of such data but continue to store the data
                  and use it for internal purposes to further improve our
                  services.
                </li>
                <li>
                  In our efforts to continually improve our product and service
                  offerings, we collect and analyses demographic and profile
                  data about our {`users'`} activity on our platform.
                </li>
                <li>
              ...
              <ol style={{ listStyleType: "disc", marginBottom: "0.5rem" }}>
                <li>
                  ...
                  fraudulent or illegal activities related to our services. We
                ...
                <li>
                  ...
                  reasonably necessary to respond to court orders, or other
              ...
              <p>
                Our platform links to other e-commerce and non-e-commerce
                companies also that may collect personal information about you.
                Recycledevice is not responsible for the privacy policy and
                content of those linked companies
              </p>
              ...
              <p>
                That the platform can be used by only those who can form a
                legally binding contract as per the terms and conditions of
                Indian Contract Act, 1872. However, if any minor has shared/
                provided any information on the platform of Recycledevice
                without the supervision of parents /guardian, in that case
                parent/guardian can contact our grievance officer between office
                hours
              </p>
              ...
              <p>
                ...
                effective immediately. Your continued use of the platform shall
                be deemed to be your acceptance to the provisions of the privacy
                policy. User agree that any information Recycledevice hold about
                user (as described in this privacy policy and whether or not
                collected prior to or after the new privacy policy became
                effective) will be governed by the latest version of the privacy
                policy.
              </p>
